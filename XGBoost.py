...
def xgb(X, y, X_test, y_test):
    ...
    #SPLIT TRAIN DATASET IN TRAIN/TEST 70/30
    ...
    # precision
    print("\nPrecision:")
    print(precision_score(le.fit_transform(y_test), y_pred, average=None))

    # recall
    print("\nRecall:")
    print(recall_score(le.fit_transform(y_test), y_pred, average=None))

    # f1
    print("\nf1:")
    print(f1_score(le.fit_transform(y_test), y_pred, average=None))